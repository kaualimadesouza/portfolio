...
import { SOCIAL_LINKS, RESUME_URL } from '../../domain/data/constants';
...
export function SocialLinks() {
  ...
  return (
    <nav className="flex gap-6 text-textlow items-center" aria-label={language === 'pt' ? 'Redes sociais' : 'Social links'}>
